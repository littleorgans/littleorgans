...
- Do not assert root install or release recipe policy from substrate app tests. That coverage belongs at the `lilo` operator surface if it belongs anywhere.
