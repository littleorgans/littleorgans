...
pub(super) fn mcp_namespace_scope_params() -> Vec<ToolParamContract> {
    vec![
        ToolParamContract {
            ...
            required: false,
            enum_values: None,
            mcp_description: "Namespace slug to scope this tool. Overrides the caller session namespace fallback.".to_string(),
            cli_help: None,
            cli_flag: None,
            selector: false,
        ...
        ToolParamContract {
            ...
            required: false,
            enum_values: None,
            mcp_description: "Bypass namespace scoping and match across all namespaces.".to_string(),
            cli_help: None,
            cli_flag: None,
            selector: false,
