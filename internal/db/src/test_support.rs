...
/// Local default used when no admin URL is configured in the environment.
const DEFAULT_ADMIN_URL: &str = "postgres://lilo:lilo@localhost:5432/lilo";
...
/// Admin/maintenance URL for provisioning: `LILO_TEST_DATABASE_URL`, then
/// `LILO_DATABASE_URL`, then the local default.
pub(crate) fn admin_url() -> String {
    lilo_paths::env::test_database_url()
        .or_else(lilo_paths::env::database_url)
