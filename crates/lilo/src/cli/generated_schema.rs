  ...
  "groups": [
    {
      "commands": [
        ...
        },
        {
          ...
          "group": "session",
          "hidden": null,
          "long_about": "Send and inspect agent mail. `mail send` delivers a message to a recipient selector with an intent (request, result, or inform); `mail peek` and `mail tail` inspect a conversation; `mail read` manages an inbox.",
          "name": "mail"
        },
        {
